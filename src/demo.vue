      ...
      <gua-sub-nav>
        ...
        <gua-sub-nav>
          ...
          <gua-sub-nav>
            ...
            <gua-nav-item name="cn">电信</gua-nav-item>
          </gua-sub-nav>
        </gua-sub-nav>
      </gua-sub-nav>
...
<script>
import GuaNav from './nav/nav'
import GuaNavItem from './nav/nav-item'
import GuaSubNav from './nav/sub-nav'

export default {
  name: 'demo',
  components: { GuaNav, GuaNavItem, GuaSubNav },
  data () {
    return {
      selected: ['culture']
    }
